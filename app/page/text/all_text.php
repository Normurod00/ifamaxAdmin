...
// Инициализация переменных для фильтров поиска
$title = $_GET['title'] ?? '';
...
<div class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-dark text-white" style="width: 280px; height:100vh">
    ...
    <div class="container-fluid mt-5">
        ...
        <form method="GET" class="row g-2 mb-4">
            <div class="col-md-2">
                <input type="text" name="title" class="form-control" placeholder="Заголовок" value="<?= htmlspecialchars($title) ?>">
            </div>
            <div class="col-md-2">
                <input type="text" name="heading" class="form-control" placeholder="Подзаголовок" value="<?= htmlspecialchars($heading) ?>">
            </div>
            <div class="col-md-2">
                <input type="text" name="description" class="form-control" placeholder="Описание" value="<?= htmlspecialchars($description) ?>">
            </div>
            <div class="col-md-2">
                <input type="text" name="url" class="form-control" placeholder="Ссылка" value="<?= htmlspecialchars($url) ?>">
            </div>
            <div class="col-md-2">
                <input type="text" name="content" class="form-control" placeholder="Текст" value="<?= htmlspecialchars($content) ?>">
            </div>
            <div class="col-md-2">
